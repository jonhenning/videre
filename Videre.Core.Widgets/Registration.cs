...
namespace Videre.Core.Widgets
{
    public class Registration : IWidgetRegistration
    {
        public int Register()
        {
            ...
            updates += CoreServices.Update.Register(new CoreModels.AttributeDefinition() { GroupName = "Account", Name = "AccountProvider", DefaultValue = CoreServices.Account.AccountService.GetType().FullName, Required = false, LabelKey = "AccountProvider.Text", LabelText = "Account Provider", TooltipKey = "AccountProviderTooltip.Text", TooltipText = "Provider used to manage account profile information. The Account Provider can only be configured in the app.config.", ReadOnly = true });
            ...
            updates += CoreServices.Update.Register(new CoreModels.AttributeDefinition() { GroupName = "Authentication", Name = "PersistenceProvider", DefaultValue = CoreServices.Authentication.PersistenceProvider != null ? CoreServices.Authentication.PersistenceProvider.Name : "", Required = false, LabelKey = "AuthenticationPersistenceProvider.Text", LabelText = "Authentication Persistence Provider", TooltipKey = "PersistenceProviderTooltip.Text", TooltipText = "Provider used to store user authentication credentials.  It is configured in the app.config", ReadOnly = true });
