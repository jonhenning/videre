    ...
    public class Web
    {
        public static List<Models.WebReference> GetDefaultWebReferences(string portalId = null)
        {
            ...
            return new List<WebReference>()
            {
                ...
                new WebReference() { Name = "datatables tabletools", Group = "datatables tabletools", LoadType = WebReferenceLoadType.Defer, Type = WebReferenceType.ScriptReference, PortalId = portalId, Url = "~/scripts/DataTables-1.9.0/media/js/TableTools.min.js", DependencyGroups = new List<string>() {"datatables"}, Sequence = 0  },
                new WebReference() { Name = "datatables zeroclipboard", Group = "datatables tabletools", LoadType = WebReferenceLoadType.Defer, Type = WebReferenceType.ScriptReference, PortalId = portalId, Url = "~/scripts/DataTables-1.9.0/media/js/ZeroClipboard.js", Sequence = 1 },
