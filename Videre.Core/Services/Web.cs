...
namespace Videre.Core.Services
{
    public class Web
    {
        public static List<Models.WebReference> GetDefaultWebReferences(string portalId = null)
        {
            ...
            {
                //new WebReference() { Name = "jQuery", Group = "jQuery", LoadType = WebReferenceLoadType.Defer, Type = WebReferenceType.ScriptReference, PortalId = portalId, Url = "~/scripts/jquery-1.7.1/jquery-1.7.1.min.js" },
                ...
                //new WebReference() { Name = "bootstrap css", Group = "bootstrap css", LoadType = WebReferenceLoadType.Defer, Type = WebReferenceType.StyleSheetReference, PortalId = portalId, Url = "~/scripts/bootstrap-2.1.0/css/bootstrap.min.css" },
                ...
                //new WebReference() { Name = "datatables", Group = "datatables", LoadType = WebReferenceLoadType.Defer, Type = WebReferenceType.ScriptReference, PortalId = portalId, Url = "~/scripts/DataTables-1.9.4/media/js/jquery.dataTables.min.js", DependencyGroups = new List<string>() {"jQuery"}, Sequence = 0  },
                //new WebReference() { Name = "datatables bootstrap", Group = "datatables", LoadType = WebReferenceLoadType.Defer, Type = WebReferenceType.ScriptReference, PortalId = portalId, Url = "~/scripts/DataTables-1.9.4/media/js/jquery.dataTables.bootstrap.js", Sequence = 1 },
                //new WebReference() { Name = "datatables css", Group = "datatables", LoadType = WebReferenceLoadType.Defer, Type = WebReferenceType.StyleSheetReference, PortalId = portalId, Url = "~/scripts/DataTables-1.9.4/media/css/jquery.dataTables.bootstrap.css" },

                //new WebReference() { Name = "datatables zeroclipboard", Group = "datatables tabletools", LoadType = WebReferenceLoadType.Defer, Type = WebReferenceType.ScriptReference, PortalId = portalId, Url = "~/scripts/DataTables-1.9.4/media/js/ZeroClipboard.js", DependencyGroups = new List<string>() {"datatables"}, Sequence = 0 },
                //new WebReference() { Name = "datatables tabletools", Group = "datatables tabletools", LoadType = WebReferenceLoadType.Defer, Type = WebReferenceType.ScriptReference, PortalId = portalId, Url = "~/scripts/DataTables-1.9.4/media/js/TableTools.min.js", Sequence = 1 },
                ...
                //new WebReference() { Name = "CKTextEditor", Group = "CKTextEditor", LoadType = WebReferenceLoadType.Defer, Type = WebReferenceType.ScriptReference, PortalId = portalId, Url = "~/scripts/controls/core/CKTextEditor/ckeditor_3.6.4/ckeditor.js", Sequence = 0, DependencyGroups = new List<string>() {"jQuery"} },
                //new WebReference() { Name = "CKTextEditor jQuery adapter", Group = "CKTextEditor", LoadType = WebReferenceLoadType.Defer, Type = WebReferenceType.ScriptReference, PortalId = portalId, Url = "~/scripts/controls/core/CKTextEditor/ckeditor_3.6.4/adapters/jquery.js", Sequence = 1, DependencyGroups = new List<string>() {"jQuery"} },

                //new WebReference() { Name = "WYSIHTML5", Group = "WYSIHTML5TextEditor", LoadType = WebReferenceLoadType.Defer, Type = WebReferenceType.ScriptReference, PortalId = portalId, Url = "~/scripts/controls/core/WYSIHTML5TextEditor/WYSIHTML5_0.2/lib/js/wysihtml5-0.3.0.min.js", Sequence = 0, DependencyGroups = new List<string>() {"jQuery"} },
                //new WebReference() { Name = "WYSIHTML5 bootstrap", Group = "WYSIHTML5TextEditor", LoadType = WebReferenceLoadType.Defer, Type = WebReferenceType.ScriptReference, PortalId = portalId, Url = "~/scripts/controls/core/WYSIHTML5TextEditor/WYSIHTML5_0.2/dist/bootstrap-wysihtml5-0.0.2.min.js", Sequence = 1, DependencyGroups = new List<string>() {"jQuery"} },
